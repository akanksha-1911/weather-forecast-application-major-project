...
let WeatherContainer = document.querySelector(".Main_Container")
let CurrentDate = document.getElementById("Date");
let CurrentTime = document.getElementById("Time");
let City = document.getElementById("Location_Name");
...
SearchButton.addEventListener('click', (event)=>{
    ...
    if(SearchCity.value.match(CheckCity) && len.length != 0){
        ...
        ErrorMsg.innerHTML ="Please Enter Valid Location!";
...
const GetWeather =  (city) =>{
    ...
    .then(data =>{ 
        ...
        ErrorMsg.innerHTML =`${city}'s Weather Details`;
        HideErrorMsg();
